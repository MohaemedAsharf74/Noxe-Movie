    ...
    return <><div className='my-4'>
        {/* <nav aria-label='...' className='pt-5'>
            <ul className='pagination pagination-sm d-flex justify-content-center'>
                <li onClick={() => getPopular(params.type, '1')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>1</Link>
                </li>
                <li onClick={() => getPopular(params.type, '2')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>2</Link>
                </li>
                <li onClick={() => getPopular(params.type, '3')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>3</Link>
                </li>
                <li onClick={() => getPopular(params.type, '4')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>4</Link>
                </li>
                <li onClick={() => getPopular(params.type, '5')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>5</Link>
                </li>
                <li onClick={() => getPopular(params.type, '6')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>6</Link>
                </li>
                <li onClick={() => getPopular(params.type, '7')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>7</Link>
                </li>
                <li onClick={() => getPopular(params.type, '8')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>8</Link>
                </li>
                <li onClick={() => getPopular(params.type, '9')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>9</Link>
                </li>
                <li onClick={() => getPopular(params.type, '10')} className='page-item p-1'>
                    <Link className='page-link bg-transparent text-white '>10</Link>
                </li>
            </ul>
        </nav> */}

        <form action="" className="form-inline d-flex justify-content-center mb-3" >
            <input onChange={(e) => { e.target.value === '' ? getPopular(params.type, '1') : Search(e.target.value, params.type) }} className="form-control mr-sm-2 w-50 my-5" type="search" placeholder="Search" aria-label="Search" />
        </form>
